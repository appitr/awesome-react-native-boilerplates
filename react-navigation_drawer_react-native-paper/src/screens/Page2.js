...
import { List, Divider, withTheme, Appbar } from "react-native-paper";
        ...
        return (
            <View>
                <Appbar.Header>
                    ...
                    />
                    <Appbar.Content title="Page2" subtitle="Subtitle" />
                </Appbar.Header>
                <ScrollView
                ...
                >
                    ...
                    <List.Section title="Expandable list with icons">
                        ...
                        >
                            <List.Item
                                left={props => (
                                    <List.Icon {...props} icon="thumb-up" />
                                )}
                                title="List item 1"
                            />
                            <List.Item
                                left={props => (
                                    <List.Icon {...props} icon="thumb-down" />
                                )}
                                title="List item 2"
                            />
                        </List.Accordion>
